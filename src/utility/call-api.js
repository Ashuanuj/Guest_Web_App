...
export default async  function callApi(endpoint, body, method, queryData, isFile = false, outside = false) {
     ...
     const accessToken = 'JWT eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MiwibGFzdF9uYW1lIjoiQmFuc2FsIiwiZG9iIjoiMjAxOC0xMS0xNCIsImlhdCI6MTU3MTMwNjYzMSwiZXhwIjoxNTc5OTQ2NjMxfQ.IZUEY5BltAltxWL-9SYw1SfHOjLOh3S47xfYKfHbDVM' //await sessionStorage.getItem('accessToken');
